...
class LRUEviction : public CacheEviction {
 public:
  ...
  LRUEviction(
      ...
      size_t maxBatch = kDefaultMaxBatchToEvict) :
  ...
  static constexpr size_t kDefaultCapacity = (size_t) 15 * 1024 * 1024 * 1024; // NOLINT
  static constexpr size_t kDefaultOptimal = (size_t) 10 * 1024 * 1024 * 1024; // NOLINT
  static constexpr size_t kDefaultMinBatchToEvict = (size_t) 100; // NOLINT
  static constexpr size_t kDefaultMaxBatchToEvict = (size_t) 200; // NOLINT
