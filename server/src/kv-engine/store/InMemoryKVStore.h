...
class InMemoryKVStore: public ProxyKVStore {
 ...
 private:
  std::unordered_map<KeyType, std::tuple<ValueType, VersionType, TTLType,
      utils::TimeType, utils::TimeType>, std::hash<KeyType>> mData;
  std::unordered_map<KeyType, goblin::proto::UserDefinedMeta> mUdfMetaMap;
  std::unordered_map<KeyType, VersionType, std::hash<KeyType>> mDeletedData;
};
