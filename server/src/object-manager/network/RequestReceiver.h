...
#ifndef SERVER_SRC_OBJECT_MANAGER_NETWORK_REQUESTRECEIVER_H_
#define SERVER_SRC_OBJECT_MANAGER_NETWORK_REQUESTRECEIVER_H_
...
class RequestReceiver final {
 public:
    RequestReceiver(const INIReader &, std::shared_ptr<kvengine::KVEngine>);
...
#endif  //  SERVER_SRC_OBJECT_MANAGER_NETWORK_REQUESTRECEIVER_H_
